...
func (r *jobRepo) Create(ctx context.Context, userID string, projectID, opportunityID, researchID, ideaID *string, kind string, cost int64, params []byte) (domain.GenerationJob, error) {
	if params == nil {
		params = []byte("{}")
	}
